...
i) Active: An event that has not been canceled and has not finished is considered
active.
ii) OpenForRegistration : events that are open for registration
iii) All : all events including past and canceled events.
